          ...
          <div className="grid lg:grid-cols-5 gap-6 mb-28">
            {[
              { title: "Concept & Design", img: "/images/epc-design.webp" },
              {
                ...
                img: "/images/epc-procure.webp",
              },
              {
                title: "Erection & Installation",
                img: "/images/epc-erection.webp",
              },
              {
                title: "Testing & Commissioning",
                img: "/images/epc-testing.webp",
              },
              {
                title: "O&M – Plant Lifecycle",
                img: "/images/epc-lifestyle.webp",
              },
            ].map((item, i) => (
              <div
                key={item.title}
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center mb-16">
            ...
            <div data-aos="fade-right">
              ...
              <p className="text-gray-700 leading-relaxed mb-5 max-w-xl">
                ...
                performance-first approach ensuring operational stability,
                safety, and long-term durability.
              </p>

              <p className="text-gray-600 leading-relaxed max-w-xl">
                Our EPC capabilities span Utility Scale SPV Power Plants and
                Rooftop Solar PV systems, executed under strict engineering and
